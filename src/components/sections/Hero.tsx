  ...
  return <section className="container py-8 md:py-12 lg:py-14 max-h-[70vh] overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-10 xl:gap-14 items-center">
        ...
        <div className="relative w-full overflow-hidden animate-slide-in-right -ml-3 sm:-ml-4 lg:-ml-6 xl:-ml-8 mx-0">
          ...
          <div className="pointer-events-none absolute inset-x-0 top-0 h-6 bg-gradient-to-b from-background via-background/80 to-transparent" />
          <div className="pointer-events-none absolute inset-y-0 left-0 w-4 bg-gradient-to-r from-background via-background/80 to-transparent" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-4 bg-gradient-to-l from-background via-background/80 to-transparent" />
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-b from-transparent via-background/70 to-background" />
        </div>
      </div>
    </section>;
};
