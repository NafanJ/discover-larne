...
const Hero = () => {
  ...
  return (
    <section className="container py-8 md:py-12 lg:py-14 max-h-[70vh] overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.25fr] gap-10 xl:gap-14 items-center">
        ...
        <div className="relative w-full animate-slide-in-right lg:ml-0 xl:ml-4 max-h-[60vh] overflow-hidden">
          <div className="rotate-[15deg] origin-top transform-gpu scale-[0.85] [mask-image:linear-gradient(to_bottom,transparent,black_12%,black_88%,transparent)]">
